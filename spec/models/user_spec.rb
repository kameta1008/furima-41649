...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録できるとき' do
      it 'nickenameとemail、passwordとpassword_comfirmation、first_nameとlast_name、first_name_kanaとlast_name_kana、date_of_birthが存在すれば登録できる' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordに全角文字を含む場合は登録できない' do
        @user.password = '全角文字入力'
        @user.password_confirmation = '全角文字入力'
        @user.valid?
